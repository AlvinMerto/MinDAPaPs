	...
	<ul class='nav-li'> 
		<li> 
			...
			<ul class='nav-li-li'>
				...
				<li> <a href="{{ route('page8') }}" style='font-weight: bold;'/> Percent Share of Ongoing ODA Programs and Projects in Mindanao, by LOAN AMOUNT </a> </li>
			</ul>
		</li>
	</ul>
</div>
...
<div style="margin-top: 50px;">
	<img src="{{ asset('/minda_images/neda/8.png') }}" style="width: 1355px;"/>
</div>	