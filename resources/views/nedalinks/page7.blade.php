	...
	<ul class='nav-li'> 
		<li> 
			...
			<ul class='nav-li-li'>
				...
				<li> <a href="{{ route('page7') }}" style='font-weight: bold;'/> Percent Share of Ongoing ODA Programs and Projects in Mindanao, by GRANT AMOUNT </a> </li>
...
<div style="margin-top: 50px;">
	<img src="{{ asset('/minda_images/neda/7.png') }}" style="width: 1355px;"/>
</div>	