	...
	<ul class='nav-li'> 
		<li> 
			...
			<ul class='nav-li-li'>
				...
				<li> <a href="{{ route('page6') }}" style='font-weight: bold;'/> Percent Share of Ongoing ODA Programs and Projects in Mindanao, by Type of Assistance </a> </li>
...
<div style="margin-top: 50px;">
	<img src="{{ asset('/minda_images/neda/6.png') }}" style="width: 1355px;"/>
</div>	