	...
	<ul class='nav-li'> 
		<li> 
			...
			<ul class='nav-li-li'>
				...
				<li> <a href="{{ route('page4') }}" style='font-weight: bold;'/> Percentage of On-going ODA Programs and Projects in Mindanao, by sector </a> </li>
...
<div style="margin-top: 50px;">
	<img src="{{ asset('/minda_images/neda/4.png') }}" style="width: 1355px;"/>
</div>	