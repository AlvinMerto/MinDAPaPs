	...
	<ul class='nav-li'> 
		<li> 
			...
			<ul class='nav-li-li'>
				...
				<li> <a href="{{ route('page3') }}" style='font-weight: bold;'/> Number of On-going ODA Programs and Projects in Mindanao, by sector </a> </li>
...
<div style="margin-top: 50px;">
	<img src="{{ asset('/minda_images/neda/3.png') }}" style="width: 1355px;"/>
</div>	